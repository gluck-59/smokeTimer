...
Пока дыма нет — вентилятор откл и пишется статистика в массив arrStat. Когда дыма больше чем среднее из arrStat на sensorThres — вентилятор включатеся на скорость 1 пока дыма не станет 0. 
